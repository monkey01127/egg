...
module.exports = {
  ...
  copyright: '1998-2021 吉祥航空版权所有', // copyright
  ...
  footerLinks: [
    // 页面底部链接，{link: '链接地址', name: '名称/显示文字', icon: '图标，支持 图标库'}
    { link: 'https://oatest.juneyaoair.com/wui/main.jsp', name: '吉祥航空' },
    { link: 'https://oatest.juneyaoair.com/wui/main.jsp', icon: 'github' },
    { link: 'https://oatest.juneyaoair.com/wui/main.jsp', name: '如意到家' }
  ]
}
